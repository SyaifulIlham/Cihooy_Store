...
class KebutuhanBulanan:
    def __init__(self):
        ...
        self.payments = [
            {"name": "Tagihan Pajak Kendaraan", "icon": "https://media.istockphoto.com/id/476780428/id/vektor/desain-tipografi-pajak-mobil.jpg?s=170667a&w=0&k=20&c=Cs1XjSJw95EUCo8yr7P6clTm46cMT3S25wkWAKGgbSs="},
            {"name": "Tagihan Listrik", "icon": "https://karir.nativeindonesia.com/wp-content/uploads/2024/11/Logo_PLN.png"},
            {"name": "Tagihan Air", "icon": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQtu7NiTEQiTHb2DiM_PLde1le8zcKRv9e6A&s"},
